            ...
            <div className="flex w-full p-6 items-center justify-between">
                <Link href={'/'}>
                    <Image
                        ...
                        height="40"
                        alt="asdf"
                        src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1920px-Google_2015_logo.svg.png"></Image>
                </Link>
                <div className="flex-1">
                    <SearchBox></SearchBox>
                </div>
                <div className="hidden md:inline-flex space-x-2">
                    <RiSettings3Line className="header-icon"></RiSettings3Line>
                    <TbGridDots className="header-icon"></TbGridDots>
                </div>
