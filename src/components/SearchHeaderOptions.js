        ...
        lg:pl-52 text-gray-700 text-sm'>
            <div
                ...
                className={`flex items-center space-x-1 border-b-4 border-transparent
                    active:text-blue-500 cursor-pointer pb-3 px-2${pathname ===
                    "/search/web" && "!text-blue-600 !border-blue-600"}`}>
                <AiOutlineSearch className="text-md"></AiOutlineSearch>
                <p>All</p>
            </div>
            <div
                ...
                <AiOutlineCamera className="text-md"></AiOutlineCamera>
                <p>Images</p>
            </div>
        </div>
    )
